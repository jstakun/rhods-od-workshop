...
Now let's open another tab and connect to your `S3 Browser Console` at: https://s3browser-USERX.apps.DOMAIN. Replace USERX with your user id, and DOMAIN with cluster domain (copy from *Red Hat OpenShift Data Science* Console URL)
